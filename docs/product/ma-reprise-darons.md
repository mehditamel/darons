...
## Comparer une organisation possible

Le bilan est suivi d’un comparateur volontaire : le parent sélectionne ses jours travaillés, décale ensemble le début et la fin du travail, teste un trajet aller différent ou une extension de garde matin/soir. Chaque ajustement part des horaires propres à la journée ; la durée du travail reste constante. Le résultat compare uniquement les jours choisis et indique les créneaux encore non couverts, y compris un nouveau manque le matin. Les horaires de garde inconnus ne sont pas inventés ni comptés comme une couverture complète. Un dépassement de journée est refusé.

La simulation reste une hypothèse, distincte de tout accord de garde ou d’employeur. Elle ne modifie pas le parcours, les dates, les cases cochées, le document professionnel ou la copie locale. Elle est perdue à la fermeture ou à la modification du parcours. Le parent peut consulter puis copier ou télécharger un récapitulatif personnel, explicitement marqué comme hypothèse (et comme exemple fictif le cas échéant). Le texte contient les horaires familiaux et invite à choisir son destinataire. Aucun message n’est envoyé. Une copie impossible déclenche un téléchargement annoncé. Après confirmation réelle, le parent peut reporter les horaires dans le formulaire existant ; le comparateur n’applique rien automatiquement.

Le formulaire permet aussi de copier les horaires depuis n’importe quel jour travaillé, puis d’annuler cette copie tant qu’aucune journée n’a été modifiée. Les erreurs de formulaire et de simulation reçoivent le focus clavier. Tests : calcul combiné, effet matin/soir, jours variables et week-end, trajet vide ou nul, garde inconnue, entrées invalides, conservation du parcours et du document RH, export de repli et copie depuis le mardi avec annulation ; comparaison ouverte auditée en clair/sombre à 320 et 1440 px.
