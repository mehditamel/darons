import { DaronsLogo, DaronsMark } from "@/components/brand/darons-logo";
...
export function Footer({ variant = "full" }: FooterProps) {
  ...
  return (
    <footer className="family-footer border-t bg-card py-16">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          <div>
            <Link
              ...
              className="darons-home-link inline-block mb-4"
            >
              <DaronsLogo />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a
                  href="mailto:contact@darons.app"
                  className="hover:text-foreground transition-colors"
                >
                  contact@darons.app
                </a>
        ...
        <div className="family-footer-signature" aria-hidden="true">
          <DaronsMark />
