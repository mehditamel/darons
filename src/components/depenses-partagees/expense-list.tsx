...
import { DeleteExpenseButton } from "@/components/depenses-partagees/delete-expense-button";
...
export function ExpenseList({ expenses, allowDelete = false }: ExpenseListProps) {
